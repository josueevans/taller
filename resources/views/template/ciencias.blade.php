...
@section('contenido_central')
    ...
    <div class="container mb-3" id="contenido1">
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <h1>Carreras</h1>
                <form action="{{ route('selecciona1') }}" method="POST" id="otro">
                    @csrf
                ...
                @if ($carreraSeleccionada)
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var urlServidor = "https://taller-production.up.railway.app/ciencias"; // especifica la URL del servidor en una variable
